...
Additionally, to generate timing statistics for the program you can run the command: 
	python expStats2.py 
This command will output average times for different sizes of n (based on hard coded values of n) to 4 
